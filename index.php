...
<html lang="en">
    ...
    <body style=" background-image=kit.png">
    
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
        <header>
        <nav class="navbar navbar-expand-lg" id="nav">
  <div class="container-fluid">
    <a class="navbar-brand" href="form1.php">Acceuil</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      ...
      <div id="carouselExampleDark" class="carousel carousel-dark slide carousel slide w-50 container d-flex justify-content-center" style="">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="10000">
      <img src="preg.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block" id="slide1">
        <h5>La santé, c'est comme l'argent, on n'en prend conscience que lorsqu'on en manque.</h5>
        <p>Henri-Frédéric Amiel </p>
      </div>
    </div>
    <div class="carousel-item" data-bs-interval="2000">
      <img src="pres.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block"  id="slide2">
        <h5>La santé est un état de complète harmonie du corps et de l'esprit. Lorsque l'on est libre de dysfonctionnement physique et mental, la porte de l'âme s'ouvre.</h5>
        <p> B.K.S. Iyengar</p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="happy.png" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block"  id="slide">
        <h5>Pour jouir d'une bonne santé, il faut manger modérément, respirer profondément, travailler intelligemment, se préserver de l'excès et se réjouir toujours.</h5>
        <p>Bouddha</p>
      </div>
    </div>
  </div>
