...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
  ...
  <div class="container-fluid">
    ...
    <div class="container">
        ...
        // Requête pour sélectionner tous les patients
        $con = connexion();
        $sql = "SELECT * FROM dossier_patient";
        $result = $con->query($sql);

        // Afficher la liste des patients dans un tableau avec Bootstrap
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<td><a href="modifierpatient.php?code=' . $row['code'] . '" class="btn btn-info text-white">Modifier</a></td>'; // Bouton Modifier avec lien vers la deuxième page
                echo '</tr>';
            }
            echo '</tbody>';
            echo '</table>';
        } else {
            echo '<div class="alert alert-warning" role="alert">Aucun patient trouvé.</div>';
        }
