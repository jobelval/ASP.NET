...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
  ...
  <div class="container-fluid">
    ...
    <div class="container">
        <form action="trouverpatient.php" method="post">
            <div class="form-group">
                <label for="mode">Mode de recherche :</label>
                <select class="form-control" name="mode" id="mode">
                    <option value="code">Par code</option>
                    <option value="nom_prenom">Par nom et prénom</option>
                </select>
            </div>
            <div class="form-group">
                <label for="recherche">Recherche :</label>
                <input type="text" class="form-control" name="recherche" id="recherche" required>
            </div>
