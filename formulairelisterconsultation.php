...
<head>
    ...
    <link rel="stylesheet" href="listerconsultation.css">
</head>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
  ...
  <div class="container-fluid">
    ...
    <div class="container mt-5">
        <h1 class="text-center text-info">Liste des consultations par patient</h1>
        <form action="listerpatient.php" method="post" class="mt-4">
            <fieldset>
                <legend class="text-info">Liste des consultations par patient</legend>
                <div class="form-group row">
                    <label for="codepatient" class="col-sm-5 col-form-label">Code Patient :</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="codepatient" name="codepatient" required>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-12">
