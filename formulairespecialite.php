...
<head>
    ...
    <title>Recherche de médecins par spécialité</title>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
  ...
  <div class="container-fluid">
    ...
    <div class="container mt-5">
        <form action="listermedecin.php" method="post">
            <div class="card shadow-lg">
                <div class="card-header bg-info text-white">
                    <h5 class="card-title">Recherche de médecins par spécialité</h5>
                </div>
                <div class="card-body">
                    ...
                    <button type="submit" class="btn bg-info text-white">Rechercher</button>
                </div>
            </div>
        </form>
    </div>
